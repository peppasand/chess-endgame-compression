...
ATTRIBUTE_DESCRIPTIONS = {
    ...
    # KRKN attributes
    'fDiffKR':     'Διαφορα στηλης: λευκος βασιλιας - πυργος (KRKN)',
    'rDiffKR':     'Διαφορα γραμμης: λευκος βασιλιας - πυργος (KRKN)',
    'fDiffKN':     'Διαφορα στηλης: λευκος βασιλιας - μαυρος ιππος (KRKN)',
    'rDiffKN':     'Διαφορα γραμμης: λευκος βασιλιας - μαυρος ιππος (KRKN)',
    'fDiffkR':     'Διαφορα στηλης: μαυρος βασιλιας - πυργος (KRKN)',
    'rDiffkR':     'Διαφορα γραμμης: μαυρος βασιλιας - πυργος (KRKN)',
    'fDiffkN':     'Διαφορα στηλης: μαυρος βασιλιας - ιππος (KRKN)',
    'rDiffkN':     'Διαφορα γραμμης: μαυρος βασιλιας - ιππος (KRKN)',
    'fDiffRN':     'Διαφορα στηλης: πυργος - ιππος (KRKN)',
    'rDiffRN':     'Διαφορα γραμμης: πυργος - ιππος (KRKN)',
    'dist_wK_bK':  'Chebyshev αποσταση βασιλιαδων (Opposition) (KRKN)',
    'bK_in_corner':'Αν ο μαυρος βασιλιας ειναι στη γωνια (Y/N) (KRKN)',
    # KBBK attributes
...
def csv_to_arff(csv_filename, mode='wtm'):
    ...
    # Metadata columns: αποθηκευονται στο CSV για το compress_exceptions.py
    # αλλα ΔΕΝ πρεπει να μπουν στο ARFF ως Weka attributes
    METADATA_COLS = {'wKSq', 'wPSq', 'wQSq', 'wRSq',
                     'wB1Sq', 'wB2Sq', 'wNSq', 'bKSq', 'bNSq'}

    attr_cols = [c for c in columns
                 if c != 'result' and c not in METADATA_COLS]
    ...
    # Data section
    lines.append('@data')
    # Χρησιμοποιουμε attr_cols + result — ΟΧΙ τα metadata columns
    data_cols = attr_cols + ['result']
    for row in rows:
