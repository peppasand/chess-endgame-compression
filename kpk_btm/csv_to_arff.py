...
def csv_to_arff(csv_filename, mode='wtm'):
    ...
    lines.append(f'% Φιναλε: KPK {mode_desc}')
    ...
    geo_attrs      = ['wKFile','wKRank','wPFile','wPRank','bKFile','bKRank',
                      'fileDiffKk','rankDiffKk','fileDiffKP','rankDiffKP',
