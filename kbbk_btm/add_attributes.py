...
Εκδοσεις:
    v1 : sameColor + 17 γεωμετρικα + οριζοντιο mirroring (~3.6M θεσεις)
    v2 : sameColor + bK_on_edge + 17 γεωμετρικα + double mirroring (~0.9M θεσεις)
...
VERSIONS = {
    'v1': {
        'desc': 'v1 — sameColor + 17 γεωμετρικα attributes (Θανου) + single mirroring',
        'attrs': [
            'sameColor',
            'fDiffKk',  'rDiffKk',
            'fDiffKM1', 'rDiffKM1',
    ...
    'v4': {
        ...
        'attrs': [
            ...
            'bK_on_edge',
            'bK_dist_corner',
            'bK_corner_id',     # νεο: ποια ακριβως γωνια/ακρη (0-7)
            'dist_bK_wB1',
            'dist_bK_wB2',
            'fDiffKk',  'rDiffKk',
            'fDiffKM1', 'rDiffKM1',
...
def _run_validation(computed_rows, out_file, wtm=True):
    ...
    # Ελεγχος: sameColor=S πρεπει να ειναι παντα Draw
