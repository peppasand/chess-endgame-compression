...
def csv_to_arff(csv_filename, mode='wtm'):
    ...
    # Δυναμικη ανιχνευση metadata — οποια στηλη τελειωνει σε 'Sq'
    # ειναι raw square (0-63) και ΔΕΝ πρεπει να μπει στο ARFF
    # Δουλευει αυτοματα για KPK, KBBK, KRKN, KBNK κλπ
    attr_cols = [c for c in columns
                 if c != 'result' and not c.endswith('Sq')]
